function [ sam_f, sam_xi, mean_sam, std_sam, time_year, SAM_unnormalized,sam_trends_yrs ] = MPI_ESM_LR
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

%% Import Data
current_path = pwd;
pathname_ps = fullfile(current_path,'piControlData/MPI_ESM_LR_ps.cdf');
