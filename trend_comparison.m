...
model_labels = {'   ';'CCSM4';'CMCC CESM'; 'CMCC CM'; 'CMCC CMs'; 'CNRM CM5'; 'CNRM CM5-2'; 'IPSL CM5a LR'; 'IPSL CM5a MR';...
    ...
    'CM2Mc'; 'CM2.1'; '   '};
std_cmip5 = {ccsm4_std_sam; cmcc_cesm_std_sam; cmcc_cm_std_sam; cmcc_csm_std_sam; cnrm_cm5_std_sam; cnrm_cm52_std_sam;...
    ipsl_cm5a_lr_std_sam; ipsl_cm5a_mr_std_sam; ipsl_cm5b_lr_std_sam; miroc_esm_std_sam; miroc_esm_chem_std_sam;...
...
prob_cmip5 = {ccsm4_probability; cmcc_cesm_probability; cmcc_cm_probability; cmcc_cms_probability; cnrm_cm5_probability; cnrm_cm52_probability;...
    ipsl_cm5a_lr_probability; ipsl_cm5a_mr_probability; ipsl_cm5b_lr_probability; miroc_esm_probability; miroc_esm_chem_probability;...
...
Trends(1, 1:length(ccsm4_sam_trends_yrs)) = ccsm4_sam_trends_yrs;
Trends(2, 1:length(cmcc_cesm_sam_trends_yrs)) = cmcc_cesm_sam_trends_yrs;
Trends(3, 1:length(cmcc_cm_sam_trends_yrs)) = cmcc_cm_sam_trends_yrs;
Trends(4, 1:length(cmcc_cms_sam_trends_yrs)) = cmcc_cms_sam_trends_yrs;
Trends(5, 1:length(cnrm_cm5_sam_trends_yrs)) = cnrm_cm5_sam_trends_yrs;
Trends(6, 1:length(cnrm_cm52_sam_trends_yrs)) = cnrm_cm52_sam_trends_yrs;
Trends(7, 1:length(ipsl_cm5a_lr_sam_trends_yrs)) = ipsl_cm5a_lr_sam_trends_yrs;
Trends(8, 1:length(ipsl_cm5a_mr_sam_trends_yrs)) = ipsl_cm5a_mr_sam_trends_yrs;
Trends(9, 1:length(ipsl_cm5b_lr_sam_trends_yrs)) = ipsl_cm5b_lr_sam_trends_yrs;
...
Trends(17, 1:length(cm2mc_sam_trends_yrs)) = cm2mc_sam_trends_yrs;
Trends(18, 1:length(cm21_sam_trends_yrs)) = cm21_sam_trends_yrs;
...
figure(2)
h1 = plot(1, 2*ccsm4_std_sam, '*', 'markersize', 12);
hold on
plot(2, 2*cmcc_cesm_std_sam, '*', 'markersize', 12)
plot(3, 2*cmcc_cm_std_sam, '*', 'markersize', 12)
plot(4, 2*cmcc_csm_std_sam, '*', 'markersize', 12)
plot(5, 2*cnrm_cm5_std_sam, '*', 'markersize', 12)
plot(6, 2*cnrm_cm52_std_sam, '*', 'markersize', 12)
plot(7, 2*ipsl_cm5a_lr_std_sam, '*', 'markersize', 12)
plot(8, 2*ipsl_cm5a_mr_std_sam, '*', 'markersize', 12)
plot(9, 2*ipsl_cm5b_lr_std_sam, '*', 'markersize', 12)
...
plot(17, 2*cm2mc_std_sam, '*', 'markersize', 12)
plot(18, 2*cm21_std_sam, '*', 'markersize', 12)
